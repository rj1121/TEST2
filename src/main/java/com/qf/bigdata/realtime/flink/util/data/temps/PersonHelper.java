...
public class PersonHelper {
    ...
    public static final String KEY_LANGAGE = "langage";
    ...
    public static Map<String,Object> getTempData(String curTime, Integer count) throws Exception{
        ...
        Integer num = CommonUtil.getRandomNum(6);
        result.put(KEY_NUM, String.valueOf(num));
        ...
        Integer gender = num%2==0?1:0;
        result.put(KEY_GENDER, String.valueOf(gender));

        String langage = CommonUtil.getRandomChar(1);
        result.put(KEY_LANGAGE, langage);
...
//        String s = "--topic t_person --count 2 --sleep 2000";
